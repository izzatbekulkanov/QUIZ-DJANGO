...
from .view.help import (
    DeleteAllHelpPlansView,
    DeleteHelpPlanView,
    HelpAssignmentDetailView,
    HelpPlansView,
    HelpUserDetailView,
    HelpUsersView,
)
...
urlpatterns = [
    ...
    path('tests/<int:test_id>/questions/delete-all/', QuestionsBulkDeleteApiView.as_view(), name='questions-bulk-delete'),
    ...
    path('help/', HelpUsersView.as_view(), name='help-users'),
    path('help/plans/', HelpPlansView.as_view(), name='help-plans'),
    path('help/plans/delete-all/', DeleteAllHelpPlansView.as_view(), name='delete-all-help-plans'),
    path('help/plans/<int:plan_id>/delete/', DeleteHelpPlanView.as_view(), name='delete-help-plan'),
    path('help/<int:user_id>/assignments/<int:assignment_id>/', HelpAssignmentDetailView.as_view(), name='help-assignment-detail'),
    path('help/<int:user_id>/', HelpUserDetailView.as_view(), name='help-user-detail'),
