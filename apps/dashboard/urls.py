...
urlpatterns = [
    ...
    path('tests/<str:assignment_id>/instructions/', StartTestDetailView.as_view(), name='start-test-detail'),
    path('tests/<str:assignment_id>/start/', StartTestView.as_view(), name='start-test'),
    ...
    path('tests/<str:assignment_id>/unfinished-status/', CheckUnfinishedTestView.as_view(), name='check-unfinished-test'),
