  ...
  _uiApiLayout(mode = 'init') {
    ...
    let layoutAPI = {
      ...
      dark_mode_on: () => {
        ...
        // Save to cookie
        document.cookie = "dark_mode=true; path=/; max-age=" + 60 * 60 * 24 * 30; // 30 kun davomida saqlash

        // Additional dark mode handling
      ...
      dark_mode_off: () => {
        ...
        // Save to cookie
        document.cookie = "dark_mode=false; path=/; max-age=" + 60 * 60 * 24 * 30; // 30 kun davomida saqlash
