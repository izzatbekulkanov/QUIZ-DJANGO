            ...
            recent_outputs.append(
                {
                    ...
                    "download_url": reverse("generation-download", args=[file_path.parent.name, file_path.name]),
            ...
            results.append(
                {
                    ...
                    "txt_download_url": reverse("generation-download", args=[run_id, result.txt_path.name]),
                    "docx_download_url": reverse("generation-download", args=[run_id, result.docx_path.name]),
